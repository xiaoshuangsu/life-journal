...
export default function EntryDetail({
    ...
    return (
      <div className="max-w-2xl py-2">
        ...
        <textarea
          ...
          maxLength={5000}
          disabled={saving}
          className="w-full resize-none rounded-lg border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-800/50 px-4 py-3 text-sm text-zinc-800 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:border-zinc-400 dark:focus:border-zinc-500 focus:outline-none transition-colors"
        />
  ...
  return (
    <div className="max-w-2xl py-2">
      ...
      {/* Divider */}
      <div className="mt-6 border-t border-slate-200 dark:border-zinc-800" />
      ...
      <div className="mt-5 space-y-4">
        ...
        <div className="border-t border-slate-200 dark:border-zinc-800 pt-4 mt-4">
          {!insights ? (
            <div
              className={`rounded-lg border border-slate-200 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-800/50 px-4 py-3 ${
            ...
            <div className="rounded-xl border border-slate-200 dark:border-zinc-700 bg-white/80 dark:bg-zinc-900/40 px-5 py-4 space-y-4">
      ...
      <p className="mt-8 text-[11px] text-zinc-400 dark:text-zinc-700">
